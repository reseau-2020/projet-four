...
2) ping continu de pc1 vers un autre réseau (vers R2 par exemple) avec rupture de passerelle 
...
64 bytes from 10.16.224.2: icmp_seq=13 ttl=254 time=5.28 ms (rupture de passerelle DS1)
...
64 bytes from 10.16.224.2: icmp_seq=65 ttl=254 time=11.0 ms (Le DS2 intervient et prends le relais)
...
-----------------------------------------------------------------------------------------------------------
3) un ping continu d'un PC vers un PC d'un autre VLAN ; de pc1 à pc2 (vlan 10 à vlan 20) avec rupture de la liaison Po1
